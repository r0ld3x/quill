...
import { CloudIcon, File, Loader } from "lucide-react";
            ...
            >
              ...
              {acceptedFiles && acceptedFiles[0] ? (
                <div className="max-w-xs bg-white flex items-center rounded-md overflow-hidden outline-[1px] outline-zinc-200 divide-x divide-zinc-200">
                  ...
                  <div className="px-3 py-2 h-full grid place-items-center truncate">
              ...
              {uploading && (
                <div className="w-full mt-4 max-w-xs mx-auto">
                  <Progress
                    ...
                    className={cn(
                      "h-2  w-full",
                      uploadProgress === 100 ? "bg-green-500" : "bg-zinc-200"
                    )}
                  />
                  {uploadProgress === 100 && (
